...
**Version:** 0.7 · **Last updated:** 2026-08-03 · **Maintained in:** Master Coordination Chat
...
**Closed:** P0 (except P0.5–P0.8) · **P0.4 ✅ 2026-08-03** · P1 · P2.0 / P2.0b / P2.0c. Two mechanical
guards live (frozen-file, test-hygiene). On 2026-08-03 the **frozen-file** guard and the permission
layer were falsified on-repo, and the frozen-file guard has one known hole, G1, tracked as P0.8. The
**test-hygiene** guard has never been falsified on-repo — it is wired into `--tests-only` and was not
exercised by that run; do not read the D3 note as covering it. **Suite: 249 green as of 2026-08-02**
(P0.3-fix session) — **not re-run since, so it is hearsay**; the 2026-08-03 sessions changed only
docs, `.claude/settings.json` and `PREREGISTRATION.md`, none of which any test reads, but that is an
argument for the number still being *true*, not for it having been *observed*. The next session that
